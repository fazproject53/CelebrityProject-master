...
class SplashScreen extends StatefulWidget {
  ...
  final String? amount;
   ...
   const SplashScreen({Key? key, this.trueOrFalse, this.amount}) : super(key: key);
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    Timer(const Duration(seconds: 3), (){
      ...
      goTopagepush(context,  SuccessfulScreen(amount: widget.amount,)) : goTopagepush(context,FailureScreen(amount: widget.amount,));
    });
    super.initState();
  }
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              text(context, 'إضافة ${widget.amount} ريال للرصيد ', 20, black,
