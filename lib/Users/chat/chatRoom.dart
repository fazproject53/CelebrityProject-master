...
class chatRoom extends StatefulWidget{
   ...
   chatRoom({Key? key,  this.conId, this.createImage, this.createUserId, this.createName}) : super(key: key);
...
class _chatRoomState extends State<chatRoom> {
  ...
  void refresh() {
    widget.createUserId != null ? null : {_isFirstLoadRunning ? null : {
      ...
      for (int i = 0; i < _posts!.messages!.length; i++) {
        if ((_posts!.messages![i].sender!.id != userId)) {
          if(_posts!.messages![i].messageType == 'image'){
            listwidget!.add(image2(_posts!.messages![i].body, _posts!.messages![i].date!.substring(10))),
          } else
            {
              if(_posts!.messages![i].messageType == 'video'){
              ...
              } else
                {
                  if(_posts!.messages![i].messageType == 'document'){
                    listwidget!.add(document(_posts!.messages![i].body,_posts!.messages![i].date!.substring(10))),
                  ...
                  } else
                    {
                      if (_posts!.messages![i].messageType == 'voice')
                        ...
                        {
                          listwidget!.add(
                              containerUser(_posts!.messages![i].body,_posts!.messages![i].date!.substring(10).toString()) ),}}}
            }
        } else
          {
            if(_posts!.messages![i].messageType == 'image'){
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: GestureDetector(
        ...
        child:( _isFirstLoadRunning && !foundMessage) || (checkCon == null && widget.conId == null)? Scaffold(body: Center(
          ...
          appBar: drawAppBar(
            ...
            children: [
              text(context,
                  widget.createName != null ? widget.createName! : name!, textSubHeadSize,
                  white),
              SizedBox(width: 10.w,),
              CircleAvatar(
            ...
            ],), context, color: purple,iconColor: white,onPressedd: (){    inChat = false;
          theName = '';
          _controller.removeListener(_loadMore);

              Navigator.pop(context);}),
          body: (_isFirstLoadRunning && !foundMessage) ? Center(
            child: mainLoad(context),
          ) : Column(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    //   reverse: true,
                      child: ListView(
                        ...
                        children:temp!.isNotEmpty? temp!.toList() : widget.createUserId != null ? newCon.reversed
                            .toList() : newCon.reversed.toList() + listwidget!,
                      ),
                  //  ),
                ...
                _posts != null && _posts!.isBlocked!? Container(
                  ...
                  width: 350.w,decoration: BoxDecoration(color: deepBlack.withOpacity(0.20),
                    borderRadius: BorderRadius.circular(80.r)),height: 30.h,child: text(context,  ' لا يمكنك التواصل مع هذا المستخدم راجع الدعم الفني  ', 15, deepBlack, align: TextAlign.center),) :Padding(
                  padding: MediaQuery
                      .of(context)
                      .viewInsets
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(border: Border(
                        top: BorderSide(color: purple, width: 1))),
                    child: Row(
                        ...
                        children: [
                                ...
                                Container(
                                  ...
                                  child: InkWell(onTap: () {
                                    FocusManager.instance.primaryFocus
                                        ?.unfocus();
                                    widget.createUserId != null ? setState(() {
                                      ...
                                      var text = m.text;
                                      var date = dt.DateFormat('hh:mm a').format(DateTime.now());
                                      addMessage(userToken!, m.text).then((value) =>{
                                        setState(() {
                                      newCon.removeLast();
                          ...
                          Expanded(
                            child: Container(
                              height: isWritting ? 45.h : 40.h,
                              margin: EdgeInsets.only(top: 10.h,
                                  bottom: isWritting ? 0.h : 10.h,
                                  left: 20.w),
      ...
      child: Column(
        ...
        children: [
          Container(
            height: 350.h,
            width: 300.w,
            margin: EdgeInsets.only(top: 10.h, bottom: 10.h, left: 3.w, right: 5.w),
            decoration: BoxDecoration(
                color: grey,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.only(
                          topRight: Radius.circular(10)),
                      child:  !isConnectSection?  Icon(Icons.error, size: 30.h, color: red,):CachedNetworkImage(
                        imageUrl:text,
                        height: double.infinity,
                        width: double.infinity,
                        fit: BoxFit.cover,
  ...
  Widget voiceRecord(AudioPlayer ap, ur, time,{hint}) {
    var snackBar = SnackBar(
      content: text(context,'تم التحميل بنجاح', 15, white, align: TextAlign.center, fontWeight: FontWeight.bold),
      shape: StadiumBorder(),
      behavior: SnackBarBehavior.floating,
      margin: EdgeInsets.only(bottom: getSize(context).height/3, right: 130.w, left: 130.w),
      backgroundColor: Colors.black38,
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          child: an.hasData &&
                                                              (an.data!.name == 'playing' && ap.state.name == 'playing') && snap.data!.inSeconds != snapshot.data!.inSeconds
                                                              ? Icon(
                                                            Icons.pause,
                                                            color: deepBlack,
                                                            size: 35.h,
  ...
  void getConversations() async {
    if(mounted){
      ...
      final response = await http.get(
          Uri.parse('$_baseUrl${widget.conId}?page=$_page'),
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
            'Authorization': 'Bearer $userToken'
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _posts = ChatRoomModel
              ...
              .data!;
          numberOfnNotRead =  ChatRoomModel
              .fromJson(jsonDecode(response.body))
              .data!.conversation!.countNotReadAnotherUser;
          theId = ChatRoomModel
              .fromJson(jsonDecode(response.body))
              .data!
              .conversation!
              .secoundUser!
              .id;
          userId != ChatRoomModel
              .fromJson(jsonDecode(response.body))
              .data!
              .conversation!
              .secoundUser!
              .id ? name = ChatRoomModel
              .fromJson(jsonDecode(response.body))
              .data!
              .conversation!
              .secoundUser!
              .name : name = ChatRoomModel
              .fromJson(jsonDecode(response.body))
              .data!
              .conversation!
              .user!
          ...
          userId != ChatRoomModel
              ...
              .secoundUser!
              .id ?
          senderImage = ChatRoomModel
              .fromJson(jsonDecode(response.body))
              .data!
              .conversation!
              .secoundUser!
              .image : senderImage = ChatRoomModel
              .fromJson(jsonDecode(response.body))
              .data!
              .conversation!
              .user!
  ...
  Future<String> createConversation(int userId, String token, String body) async {
    Map<String, dynamic> data = {
      "user_id": '$userId',
      "body": body,};
    String url =
        "https://mobile.celebrityads.net/api/user/conversation/create";
    // try {
