...
//font size----------------------------------------------------------------
double appbarText=25;
double textHeadSize=22;
double textSubHeadSize=19; //for request in main file
double textTitleSize=17; //for adv details
double SmallbuttomSize=17;
double textDetails=14;
double largeButtonSize=20;
...
//a3458c
const Color selectblue = Color(0xFF34899e);
const Color selectpink = Color(0xFFa3458c);
...
Color greyBlack = Color(0xFF707070);
...
IconData verifyIcon=Icons.check_circle;
IconData passIcon=Icons.lock_outline;
IconData failure =Icons.priority_high;
IconData sending =Icons.pending;
IconData sent =Icons.done;
IconData emailIcon=Icons.email_outlined;
IconData nationalityIcon=Icons.flag_rounded;
...
IconData done=Icons.done_outline_outlined;
IconData disLike = Icons.favorite_border;
IconData playViduo = Icons.play_circle;
IconData playVideo = Icons.play_arrow;
