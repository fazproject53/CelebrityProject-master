...
class _MyAdvertismentState extends State<MyAdvertisment>
...
//get Advertising Orders------------------------------------------------------------------------
  Future getUserAdvertisingOrder(String token) async {
    ...
    String url =
        "https://mobile.celebrityads.net/api/celebrity/SentAdvertisingOrders?page=$page";
    ...
    try {
      ...
      if (respons.statusCode == 200) {
        ...
        MyAdvertisingOrders advertising =
            MyAdvertisingOrders.fromJson(jsonDecode(body));
