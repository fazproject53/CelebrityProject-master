...
class continueVerify extends StatefulWidget {
  String? accountType;
  Future<Verification>? verifyInfo;
  continueVerify({Key? key, this.accountType, this.verifyInfo  }) : super(key: key);
  _continueVerifyState createState() => _continueVerifyState();

}

class _continueVerifyState extends State<continueVerify> {
                ...
                onTap: (){
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context2) {
                      ...
                      addVerify().then((value) => {
                        value.contains('true')
                            ? {
                          gotoPageAndRemovePrevious(context2,  checkVerification(accountType: widget.accountType,file: file,)),
                          //done
