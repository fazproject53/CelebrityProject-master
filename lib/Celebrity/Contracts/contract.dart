                            ...
                            showDialog(context: context, builder: (BuildContext contextt){
                              return Center(
                                  child: Container(
                                    ...
                                    ,height: 450.h, width: 360.w,child:Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Wrap(textDirection: TextDirection.rtl,children: typefilter),
                                            ...
                                            // SizedBox(height: 10.h,),
                                            // Container(height: 200.h,child: SingleChildScrollView(child: Wrap(textDirection: TextDirection.rtl,children:userfilter))),
                                        ],),
                                            Card(
                                              elevation: 0,
                                              child: Row(
                                                      ...
                                                      setState((){
                                                        ...
                                                        _posts = [];
                                                          ...
                                                          both?{
                                                           ...
                                                           setState(() {
                                                             _posts.isNotEmpty?{
                                                             print('posts not empty when type'),
                                                               help =[],
                                                              help = _posts,
