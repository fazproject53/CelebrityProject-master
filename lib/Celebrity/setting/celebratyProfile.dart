...
class _celebratyProfileState extends State<celebratyProfile>
  ...
  void dispose() {
    // setState(() {
    socialMedia.face = null;
    socialMedia.insta = null;
    socialMedia.snap = null;
    socialMedia.linked = null;
    socialMedia.you = null;
    socialMedia.twit = null;
    socialMedia.tik = null;
    socialMedia.faceid = null;
    socialMedia.instaid = null;
    socialMedia.snapid = null;
    socialMedia.linkedid = null;
    socialMedia.youid = null;
    socialMedia.twitid = null;
    socialMedia.tikid = null;
    socialMedia.facenum = null;
    socialMedia.instanum = null;
    socialMedia.snapnum = null;
    socialMedia.linkednum = null;
    socialMedia.younum = null;
    socialMedia.twitnum = null;
    socialMedia.tiknum = null;
    //  });
  ...
  Future<CelebrityInformation> fetchCelebrities(String tokenn) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        catt =
            jsonDecode(response.body)["data"]?["celebrity"]['category']['name'];
        ...
        jsonDecode(response.body)["data"]?["celebrity"]['verified_status'] ==
                    null ||
                jsonDecode(response.body)["data"]?["celebrity"]
                        ['verified_status']['id'] !=
                    2
            ? verifiedDone = false
            : verifiedDone = true;
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (snapshot.hasError) {
                                  ...
                                  child: SizedBox(
                                      ...
                                      child: internetConnection(context,
                                        ...
                                        setState(() {
                                          ...
                                          pricing =
                                              fetchCelebrityPricing(userToken);
                                          fetchStudio();
                                          fetchNews(userToken);
                                        });
                                      })),
                        ...
                        socialMedia.snap = snapshot
                            ...
                            .toString()
                            .replaceAll('https://www.snapchat.com/add/', '');
                        ...
                        snapshot.data!.data!.celebrity!.name == null ||
                                snapshot.data!.data!.celebrity!.area == null ||
                                snapshot.data!.data!.celebrity!.city == null ||
                                snapshot.data!.data!.celebrity!.nationality ==
                                    null ||
                                snapshot.data!.data!.celebrity!.phonenumber ==
                                    null ||
                                snapshot.data!.data!.celebrity!.gender ==
                                    null ||
                                ...
                                ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return MaterialButton(
                                        ...
                                        child: index == 11
                                            ? addListViewButton(
                                                labels[index], icons[index], index,
                                                done: activitiesDone ||
                                                    activitiesDone2)
                                            : index == 1
                                                ? addListViewButton(
