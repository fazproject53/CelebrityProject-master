                                  ...
                                  return Center(
                                      child: SizedBox(
                                          ...
                                          child: internetConnection(context,
                                            ...
                                            setState(() {
                                              calender =
                                                  fetchCalender(userToken!);
                                              isConnectSection = true;

                                              print(
                                                  'The error is SocketException');
                                            });
                                          })));
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            gradient: LinearGradient(
                                                                              begin: const Alignment(0.8, 2.0),
                                                                              end: const Alignment(-0.69, -1.0),
                                                                              colors: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ///text
                    text(context, personalName, textError, black,
                ...
                Row(
                  ...
                  children: [
                    ...
                    ///text
                    text(context, invoices.toString(), textError, black,
                        family: 'DINNextLTArabic'),
                  ],
                ),
                SizedBox(
                ...
                Row(
                  ...
                  children: [
                    ...
                    ///text
                    text(context, typeOfOrder, textError, black,
                        family: 'DINNextLTArabic'),
                  ],
                )
              ],
